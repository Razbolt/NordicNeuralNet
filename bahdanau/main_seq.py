...
def main():
    ...
    torch.save(test_data, 'test_data_seq.pth')# Save the extracted data
    ...
    encoder = Encoder(vocab_size, 512, 512, 4, 0.5)
    decoder = Decoder(vocab_size, 512, 1024, 512, 256, 4, 0.5)
    ...
    torch.save(model.state_dict(), 'models/seq-model.pth')
